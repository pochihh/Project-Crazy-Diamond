...
// EQEP3 (axis 2) — verify against PCB; GPIO28/29/31 or GPIO6/7/9, etc.
#define EQEP3_GPIO_A  28U
#define EQEP3_GPIO_B  29U
#define EQEP3_GPIO_I  31U
...
void Encoders_init(void)
{
    ...
    eqep_gpio_setup(EQEP1_GPIO_A, EQEP1_GPIO_B,
                    ...
                    (bool)USE_EQEP1_INDEX_RESET, EQEP1_GPIO_I, GPIO_23_EQEP1I);

    // GPIO + mux for EQEP2
    eqep_gpio_setup(EQEP2_GPIO_A, EQEP2_GPIO_B,
                    GPIO_54_EQEP2A, GPIO_55_EQEP2B,
                    (bool)USE_EQEP2_INDEX_RESET, EQEP2_GPIO_I, GPIO_57_EQEP2I);

    // GPIO + mux for EQEP3
    eqep_gpio_setup(EQEP3_GPIO_A, EQEP3_GPIO_B,
                    GPIO_28_EQEP3A, GPIO_29_EQEP3B,
                    (bool)USE_EQEP3_INDEX_RESET, EQEP3_GPIO_I, GPIO_31_EQEP3I);
