...
PAGE 0 :
   ...
   RAMGS10_CODE : origin = 0x016000, length = 0x001000     /* GS10 for code overflow */
   RAMGS11_CODE : origin = 0x017000, length = 0x001000     /* GS11 for code overflow */
   RAMGS12_CODE : origin = 0x018000, length = 0x001000     /* GS12 for code overflow */
...
//   RAMM1_RSVD      : origin = 0x0007F8, length = 0x000008     /* Reserve and do not use for code as per the errata advisory "Memory: Prefetching Beyond Valid Memory" */
   ...
   RAMGS9_DMA  : origin = 0x015000, length = 0x000200     /* DMA buffers (512 bytes = 256 words) */
   RAMGS9      : origin = 0x015200, length = 0x000E00     /* Remaining RAMGS9 */
   /* RAMGS10-12 moved to PAGE 0 for code overflow */
   RAMGS13     : origin = 0x019000, length = 0x001000     /* F28379D only */
   RAMGS14     : origin = 0x01A000, length = 0x001000     /* F28379D only */
   RAMGS15     : origin = 0x01B000, length = 0x000FF8     /* F28379D only */
...
SECTIONS
{
   ...
   /* RAMLS4 reserved for CLA program — do NOT include in .text */
   .text            : >> RAMD0 | RAMLS0 | RAMLS1 | RAMLS2 | RAMLS3
                        | RAMGS10_CODE | RAMGS11_CODE | RAMGS12_CODE,   PAGE = 0
   .cinit           : > RAMM0,     PAGE = 0
   .switch          : > RAMM0,     PAGE = 0
   ...
   ramgs1           : > RAMGS1,    PAGE = 1
    ...
    .TI.ramfunc : {} > RAMGS12_CODE, PAGE = 0
   #else
