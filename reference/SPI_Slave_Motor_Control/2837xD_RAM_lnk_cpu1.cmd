/* ========================================================================== */
/* F28379D CPU1 — RAM linker, CLA enabled (LS5 program / LS4 data)            */
/* ========================================================================== */
...
/* ------------------------------ PAGE 0 (Program) -------------------------- */
   PAGE 0 :
      ...
      /* LS0..LS3 available for code */
      RAMLS0       : origin = 0x008000, length = 0x000800
      RAMLS1       : origin = 0x008800, length = 0x000800
      RAMLS2       : origin = 0x009000, length = 0x000800
      RAMLS3       : origin = 0x009800, length = 0x000800

      /* CLA program lives here (PAGE 0) */
      RAMLS5       : origin = 0x00A800, length = 0x000800

      RESET        : origin = 0x3FFFC0, length = 0x000002

      /* Flash present even in RAM build (unused here, but kept for convenience) */
      ...
      /* Reserve 0x0BFFF0..0x0BFFFF per errata if you flash-boot; not used in RAM build */
...
/* ------------------------------ PAGE 1 (Data) ----------------------------- */
   PAGE 1 :
      ...
      /* CLA data lives here (PAGE 1) */
      RAMLS4       : origin = 0x00A000, length = 0x000800

      /* GSx used for .bss/.data/.const to keep LS4/5 free for CLA */
...
/* Code - Expanded to use more LS RAM sections for debugging */
...
/* CLA code — RAM build: LOAD=RUN=RAMLS5 (copy symbols still emitted) */
   Cla1Prog :
   {
      /* your .cla functions will be pulled in by the object that references them */
   }  LOAD = RAMLS5, PAGE = 0
      RUN  = RAMLS5, PAGE = 0
